...
export default function About({ close, handleMouse }) {
  return (
    <Sho>
      <Scroll>
        <Column>
        ...
        <Column>
          ...
          <Indent>
            2013{`\t`}Far Eastern State Institute of Arts- Major: Fine Arts,
            Vladivostok, Russia
          </Indent>
        ...
        <Column>
          ...
          <Indent>
            2009{`\t`}Vladivostok Biennale of Visual Arts: Arseniev State
            Museum, Vladivostok, Russia
          </Indent>
          <Indent>2010{`\t`}Tokyo Designers Week 2010: Tokyo, Japan</Indent>
          <Indent>2011{`\t`}Plate Exhibition: Tokyo, Japan</Indent>
          <Indent>
            2011{`\t`}Vladivostok Biennale of Visual Arts: Arseniev State
            Museum, Vladivostok, Russia
          </Indent>
        ...
        <Column style={{marginTop: "6vw"}}>
          <Indent >
            2019{`\t`}Cube Moscow – Visiting Valera: Moscow, Russia
          </Indent>
          <Indent>
            2019{`\t`}Azot gallery x betweenwindows: Moscow, Russia
          </Indent>
          <Indent>2019{`\t`}0.0.0.0: Moscow, Russia</Indent>
          <Indent>2020{`\t`}Nothing box : Moscow, Russia</Indent>
          <Indent>
            2020{`\t`}Triumph Gallery – A Wave of Dreams: Moscow, Russia
          </Indent>
          <Indent>
            2020{`\t`}Art Design Human Studio – blazar: Moscow, Russia
          </Indent>
          <Indent>2020{`\t`}Art Brut Gallery – bridge: Moscow, Russia</Indent>
          <Indent>
            2020{`\t`}London Connoisseur – Four Rooms: London, England
          </Indent>
          <Indent>
          ...
          <Indent>
            2021{`\t`}+33 – The Foundation of Vladimir Smirnov and Konstantine
            Sorokin: Moscow, Russia
          </Indent>
        </Column>
        <Column style={{marginTop: "6vw"}}>
          <Indent>
            2021{`\t`}Moscow – Seoul: Shared Intentions – Museum of Moscow:
            Moscow, Russia
          </Indent>
          <Indent>
            2021{`\t`}Kurator macht blau – Anti-Festival – Academy of Fine Arts
            Vienna: Vienna, Austria
          </Indent>
          <Indent>
            2021{`\t`}1st Komi Biennale – The National Gallery of the Republic
            of Komi: Syktyvkar, Russian Federation
          </Indent>
          <Indent>
            2021{`\t`}Living Substance – The State Tretyakov Gallery : Moscow,
            Russia
          </Indent>
          ...
          <Indent>
            2021{`\t`}Le Cru Et Le Cuit – Russian Museum of Ethnography: St.
            Petersburg, Russia
          </Indent>
          <Indent>
          ...
          <Indent>
            2021{`\t`}It Will Be Clear Tomorrow Morning – Triumph Gallery:
            Moscow, Russia
          </Indent>
        </Column>
        <Column>
          ...
          <Indent>
            2019{`\t`}Devoid forms – Moscow museum of modern art: Moscow, Russia
          </Indent>
          <Indent>
            2021{`\t`}Tired Toys Are Sleeping – Nizhny Novgorod State Art
            Museum: Nizhny Novgorod, Russia
          </Indent>
        </Column>
        <Column>
          <Header>Awards</Header>
          <Indent>
            2020{`\t`}Nominee of the Sergey Kuryokhin Contemporary Art Award:
